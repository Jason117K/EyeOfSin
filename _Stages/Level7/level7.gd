...
func _configure_waves() -> void:
	...
	zombie_spawner_2.set_waves_from_dicts([{},                                                   #(0)
											{},                                                  #(0)
											{},                                         #(5-)
											{"Reborn": 4, "Unhallower" : 1},                     #(11)
											{"Unhallower": 1, "Reanimator" : 1}])                    #(15)
											
	zombie_spawner_3.set_waves_from_dicts([{"Reborn":7,"Severed":2},                             #(1+)
											{"Unhallower":1},                        #(5+)    
											{"Reborn": 2, "Sundered":2},                       #(6)
											{"Severed": 2, "Reanimator":1},                      #(12)
											{"Sundered": 6,}])                                   #(15)
											
	zombie_spawner_4.set_waves_from_dicts([{},                                                   #(0)
											{"Unhallower":1},                             #(6)
											{"Reanimator":1},                                    #(10)
											{"Severed":2 ,"Sundered":4},                         #(5)
											{"Sundered":6}])                                     #(15)
											
	zombie_spawner_5.set_waves_from_dicts([{"Reborn":7,"Severed":2 },                            #(1+)
											{"Amalgam":1,  },                                     #(5)
											{"Reborn":4, "Amalgam":1},                            #(6-)
											{"Unhallower":1, "Amalgam":1},                           #(10)
											{ "Severed":4, "Reanimator":1,"Unhallower":1}])          #(13)
