...
func _configure_waves() -> void:
	...
	zombie_spawner_1.set_waves_from_dicts([{"Reborn":7,"Severed":2},                             #(1+)
											{"Unhallower":1},                        #(5+)    
											{"Reborn": 2, "Sundered":2},                       #(6)
											{"Severed": 2, "Unhallower":1},                      #(12)
											{"Sundered": 2, "Unhallower":1}])                         #(10)
	...
	zombie_spawner_3.set_waves_from_dicts([{},                                                   #(0)
											...
											{},                                                  #(0)
											{ "Unhallower": 1},                                      #(5)
											{ "Severed":4, "Unhallower": 2}])                       #(12)
											
	zombie_spawner_4.set_waves_from_dicts([{},                                                    #(0)
											{"Severed":3},                        #(6)
											{"Reanimator":1},                                     #(10)
											{"Severed":2 ,"Sundered":3},                          #(11)
											{"Sundered":2,"Unhallower":1}])                           #(15)
	...
	zombie_spawner_7.set_waves_from_dicts([{"Reborn":7,"Severed":2},                              #(1+)
											{"Unhallower":1},                         #(5+)    
											{"Reborn": 2, "Sundered":2},                         #(6)
											{"Severed": 2, "Unhallower":1},                       #(12)
