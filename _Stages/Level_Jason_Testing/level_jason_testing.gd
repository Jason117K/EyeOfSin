...
func _ready() -> void:
	...
	#Global.register_syn_ability(Global.shroomie)
	#print_scene_tree()
...
func _configure_waves() -> void:
	...
	zombie_spawner_2.set_waves_from_dicts([{"Reanimator":1},                                                   #(0)
											{},                                                  #(0)
											{"Reanimator":1},                                    #(10)
											{ "Amagalm" : 5},                                    #(15-)
	...
	zombie_spawner_3.set_waves_from_dicts([{"Reborn": 3},                                                   #(0)
											{},                                                  #(0)
											{},                                                  #(0)
											{"Amalgam": 2},                                      #(5)
											{"Buffer": 2},                                      #(10)
	...
	zombie_spawner_4.set_waves_from_dicts([{"Unhallower":1},                                                   #(0)
											{"Unhallower":1},                                     #(5)
											{"Reanimator":1},                                    #(10)
	...
	zombie_spawner_5.set_waves_from_dicts([{"Amalgam": 2},                                                   #(0)
											{},                                                  #(0)
											{},                                                  #(0)
											{"Amalgam": 2},                                      #(5)
											{"Buffer": 2},                                      #(10)
	...
	zombie_spawner_6.set_waves_from_dicts([{"Buffer": 2},                                                   #(0)
											{},                                                  #(0)
											{"Reanimator":1},                                    #(10)
											{ "Amagalm" : 5},                                    #(15-)
											{"Sundered": 2, "Buffer" : 2},                        #(15)
			...
			#8								
	zombie_spawner_7.set_waves_from_dicts([{"Reborn":4,"Severed":4},                             #(3+)
											{"Reborn":4, "Unhallower":1},                         #(6-)
											{"Reanimator":1},                                     #(10)
											{"Reanimator":1, "Amagalm":2},                         #(15)
											{ "Sundered":3, "Buffer":2},                          #(20-)
...
func _start_free_play() -> void:
	hide_all_demon_buttons_with_exception(["Crawler","Occulum","SpinalOcculum","Wyrm","Hive","Maw", "Portal",])
